...
public class LugarController implements Serializable {
    ...
    protected static void initializeEmbeddableKey() {
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle1").getString("LugarCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle1").getString("LugarUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle1").getString("LugarDeleted"));
        if (!JsfUtil.isValidationFailed()) {
