...
public class ComputadoraController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ComputadoraCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ComputadoraUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ComputadoraDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Computadora> getItems() {
      ...
      public List<String> completeText(String query) {
        ...
        for(int i = 0; i< ejbFacade.findAll().size() ; i++) {
           if(ejbFacade.findAll().get(i).getNombrePc().contains(query)){
           results.add(ejbFacade.findAll().get(i).getNombrePc());
           }
        }
    ...
    public Computadora getComputadora(java.lang.Integer id) {
    ...
    public static class ComputadoraControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getComputadora(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Computadora) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Computadora.class.getName()});
                return null;
            }
        }
